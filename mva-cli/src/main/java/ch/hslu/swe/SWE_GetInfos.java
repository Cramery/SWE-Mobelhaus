...
public class SWE_GetInfos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dp_Von = new org.jdesktop.swingx.JXDatePicker();
        dp_Bis = new org.jdesktop.swingx.JXDatePicker();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_HausName, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                            ...
                            .addComponent(dp_Von, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(dp_Bis, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(dp_Von, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbl_Bis)
                    .addComponent(dp_Bis, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_OKActionPerformed
        ...
        //System.setProperty("java.security.policy", "C:\\Users\\Olivia Kaufmann\\Documents\\Git\\g02-mva\\mva-cli\\src\\main\\java\\ch\\hslu\\swe\\rmi.security.policy");
        ...
        String rmiUrl = "rmi://" + rmiServerIP + ":" + rmiPort + "/" + rIntAbfragen.eObjName;
        //System.out.println(rmiUrl);
        //null ? schlechte Lösung
        rIntAbfragen stub = null;
        try {

            //stub = (rIntAbfragen) Naming.lookup(rmiUrl);
            stub = (rIntAbfragen) Naming.lookup(rmiUrl);
        ...
        //++Code für Abfrage über Server in Phase 2
        //Check Möbelhersteller
        String hersteller = Integer.toString(cb_Hersteller.getSelectedIndex());

        //Check welcher Radiobutton selected ist und führe die Abfrage aus
        if (rb_AnzMHaus.isSelected()) {
            try {
                String infoMessage = stub.A01(hersteller);
                System.out.println(infoMessage);
                JOptionPane.showMessageDialog(null, infoMessage, "A01 - Mobelhauser", JOptionPane.INFORMATION_MESSAGE);
            ...
            try {
                String infoMessage = stub.A02(hersteller);
                JOptionPane.showMessageDialog(null, infoMessage, "A02 - AnzPodukttypen", JOptionPane.INFORMATION_MESSAGE);
            } catch (ParseException | IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                String infoMessage = stub.A03(hersteller);
            ...
            Date startDatum = dp_Von.getDate();
            Date endDatum = dp_Bis.getDate();
            try {
                String infoMessage = stub.A04(hersteller, startDatum, endDatum);
            ...
            Date endDatum = dp_Bis.getDate();
            try {
                String infoMessage = stub.A05(hersteller, startDatum, endDatum);
            ...
            try {
                String infoMessage = stub.A06(hersteller);
                JOptionPane.showMessageDialog(null, " Die durchschnittliche Liferzeit beträgt " + infoMessage + " Tage", "A06 - durchschnittliche Lieferzeit", JOptionPane.INFORMATION_MESSAGE);
            ...
            String infoMessage = "";
            try {
                infoMessage = stub.A07(hersteller);
            } catch (ParseException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            JOptionPane.showMessageDialog(null, infoMessage, "A07 - 5  Bestseller", JOptionPane.INFORMATION_MESSAGE);

        } else if (rb_AnzBestellWoche.isSelected()) {
            String infoMessage = "";
            try {
                infoMessage = stub.A08(hersteller);
            } catch (ParseException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            JOptionPane.showMessageDialog(null, infoMessage, "A08 -Bestellungen pro KW", JOptionPane.INFORMATION_MESSAGE);

        } else if (rb_BestellwertWoche.isSelected()) {
            String infoMessage = "";
            try {
                infoMessage = stub.A09(hersteller);
            } catch (ParseException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            JOptionPane.showMessageDialog(null, infoMessage, "A09 - Volumen pro KW", JOptionPane.INFORMATION_MESSAGE);

        }

        //++Code für Abfrage in Phase 1
        ...
        //Same part for all in this case
            try {

                String infoMessage = stub.A01(herstellerUrl);
                System.out.println("infoMessage erhalten");
                System.out.println(infoMessage);
                JOptionPane.showMessageDialog(null, infoMessage, "A01 - Mobelhauser", JOptionPane.INFORMATION_MESSAGE);
            } catch (ParseException | IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            ...
            try {
                String infoMessage = stub.A02(herstellerUrl);
                JOptionPane.showMessageDialog(null, infoMessage, "A02 - AnzPodukttypen", JOptionPane.INFORMATION_MESSAGE);
            } catch (ParseException | IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            herstellerUrl = herstellerUrl + "/ws/moebelhaus";
            try {
                String infoMessage = stub.A03(baseUrl, herstellerUrl);
                JOptionPane.showMessageDialog(null, infoMessage, "A03 - Durchschnittliche Bestellwerte", JOptionPane.INFORMATION_MESSAGE);
            } catch (ParseException | IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            Date startDatum = dp_Von.getDate();
            Date endDatum = dp_Bis.getDate();
            //Prüfen, ob beide Daten angegeben und startdatum < enddatum

            String baseUrl = herstellerUrl;
            herstellerUrl = herstellerUrl + "/ws/moebelhaus";
            try {
                String infoMessage = stub.A04(baseUrl, herstellerUrl, startDatum, endDatum);
                JOptionPane.showMessageDialog(null, infoMessage, "A04 - Gesamter Bestellwert", JOptionPane.INFORMATION_MESSAGE);
            } catch (ParseException | IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                String infoMessage = stub.A05(baseUrl, herstellerUrl);
                JOptionPane.showMessageDialog(null, infoMessage, "A05 - Grösste Bestellvolumen", JOptionPane.INFORMATION_MESSAGE);
            } catch (ParseException | IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                String infoMessage = stub.A06(baseUrl, herstellerUrl);
            ...
            herstellerUrl = herstellerUrl + " /ws/mobelhaus";

            String infoMessage = "";
            try {
                infoMessage = stub.A07(herstellerUrl);
            } catch (ParseException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(SWE_GetInfos.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btn_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_UpdateActionPerformed
        // Damit Update funktioiert muss noch RMi Schnittstelle erstellt werden
        //RMI Client Implementierung
        String rmiServerIP = "127.0.0.1";
        int rmiPort = 1099;
        //policy-Datei angeben und Security Manager installieren
        ...
        try {
            ...
            stub = (rIntAbfragen) Naming.lookup(rmiUrl);
            System.out.println("Stub wurde erstellt");
        ...
        try {
            System.out.println("Update in Progres");
            stub.Update();
        ...
        JOptionPane.showMessageDialog(null, "Update is finished", "Update", JOptionPane.INFORMATION_MESSAGE);
    ...
    private org.jdesktop.swingx.JXDatePicker dp_Bis;
    private org.jdesktop.swingx.JXDatePicker dp_Von;
